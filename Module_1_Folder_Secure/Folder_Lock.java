...
class Folder_Lock extends JFrame implements ActionListener
{
  ...
  public Folder_Lock()
  {
   try
   {
	 ...
	 File file = new File("D:\\Folder_Lock.dat");           // create file object

    AudioClip ac = Applet.newAudioClip(new File("./Please Enter Password.wav").toURL());
 	ac.play();


	 if(!(file.exists()))
	 {
	   DataOutputStream dout = new DataOutputStream(new FileOutputStream("D:\\Folder_Lock.dat"));
	 ...
	 jprgbar.setToolTipText("Bio-Security");
	 jprgbar.setIndeterminate(true);  //Show the spinning
	 jprgbar.setString("  Bio-Security  ");
	 ...
	 if(obj == login)
	 {
	  try
	  {
		if(checkPassword())
		{
		  ...
		  AudioClip ac = Applet.newAudioClip(new File("./Welcome.wav").toURL());
		  ac.play();
...
//===================================================================================================================================================================
   ...
   public boolean checkPassword()
   {
	  ...
	  try
	  {
	 	DataInputStream dout = new DataInputStream(new FileInputStream("D:\\Folder_Lock.dat"));
...
//===================================================================================================================================================================
   ...
   public void changePassword()
   {
	try
	{
	  DataInputStream din = new DataInputStream(new FileInputStream("D:\\Folder_Lock.dat"));        // Open Secure file
	  ...
	  btnOk.addActionListener(new ActionListener()
	  {
	   public void actionPerformed(ActionEvent event)
	   {
	    try
	    {
	 	  DataInputStream din = new DataInputStream(new FileInputStream("D:\\Folder_Lock.dat"));
		    ...
		    if(txtNewPass.getText().equals(txtConPass.getText()))
		    {
		     try
		     {
			   ...
			   dout.close();
  			   ...
  			   AudioClip ac = Applet.newAudioClip(new File("./password_changed.wav").toURL());
			   ac.play();


			   JOptionPane.showMessageDialog(null,"Password Changed!!!");
			   frame.setVisible(false);             // hide password window
			   new Folder_Lock().setVisible(true); // disply first window
			 }
			 catch(Exception e){}
		    }
		    else
		  ...
		  btnCancel.addActionListener(new ActionListener()
		  {
			 ...
			 {
				frame.setVisible(false);              //hide password window
				new Folder_Lock().setVisible(true);  // show first window
			 }
		   });
		}
		catch(Exception e)
...
//===================================================================================================================================================================
	...
	{
		new Folder_Lock().setVisible(true);
	}
}
